 ...
 */
export class LinkTableClass {
  constructor(head = null, tail = null, length = 0, isCircular = false, isDoubly = false, isSingly = true) {
    this.head = head;
    this.tail = tail;
    this.length = length;
