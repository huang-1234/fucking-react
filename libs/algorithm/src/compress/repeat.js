...
// 测试用例
function test() {
  console.log(decompress("HG[3|B[2|CA]]")); // "HGBCACABCACABCACA"
  console.log(decompress("a[2|b]"));        // "abb"
  console.log(decompress("3[2|A]"));         // "AAAAAA"
  console.log(decompress("abc"));            // "abc"
  console.log(decompress("[2|XY]Z"));        // "XYXYZ"
}
