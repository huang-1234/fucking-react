...
import { basicEventsCode, eventModifiersCode, typescriptCode, vModelCode } from './common'
import { message, count, isActive, handleClick, handleKeyup, toggleActive } from './hooks'
</script>
