...
import { optionsApiCode, compositionApiCode, scriptSetupCode } from './common'
import { updateCounter, triggerUpdate as triggerUpdateFn } from './hooks'
...
// 触发组件更新
const triggerUpdate = () => triggerUpdateFn(addLog)
</script>
