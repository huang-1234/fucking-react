...
createServer().then(app => {
  app.listen(5174, () => {
    console.log('SSR development server with SSE support running at http://localhost:5174');
    console.log('SSE endpoints available at:');
    console.log('- http://localhost:5174/api/events (General events)');
    console.log('- http://localhost:5174/api/stream/system (System status updates)');
  });
});
